...
- **Ölçüm:** 2026-09-22T16:12:36+00:00
- **Bölüm:** `dev`
...
|---|---|---|---|---|---|---|
| **comparative** | **0.304** | **0.600** | 1.47 | 0.261 | 0.398 | 0.976 |
...
> **BİRİNCİL (NED)** `comparative` vs `majority_character`: fark **-0.0347** (düşük olan iyi), %95 GA [-0.0753, +0.0065] → anlamlı DEĞİL — güven aralığı sıfırı içeriyor.
...
| Sistem | **NED**↓ | **BCFS**↑ | ED↓ | FER↓ | tam | kapsam |
|---|---|---|---|---|---|---|
| **comparative** | **0.300** | **0.603** | 1.46 | 0.258 | 0.386 | 0.976 |
| copy_anchor | **0.390** | **0.529** | 1.87 | 0.351 | 0.229 | 1.000 |
...
> **BİRİNCİL (NED)** `comparative` vs `majority_character`: fark **-0.0682** (düşük olan iyi), %95 GA [-0.1085, -0.0305] → **motor daha iyi**.
