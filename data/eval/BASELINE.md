...
- **Ölçüm:** 2026-09-24T08:39:51+00:00
- **Bölüm:** `dev`
...
|---|---|---|---|---|---|---|
| **comparative** | **0.306** | **0.597** | 1.49 | 0.264 | 0.398 | 0.976 |
...
> **BİRİNCİL (NED)** `comparative` vs `majority_character`: fark **-0.0329** (düşük olan iyi), %95 GA [-0.0737, +0.0085] → anlamlı DEĞİL — güven aralığı sıfırı içeriyor.
...
| Sistem | **NED**↓ | **BCFS**↑ | ED↓ | FER↓ | tam | kapsam |
|---|---|---|---|---|---|---|
| **comparative** | **0.300** | **0.602** | 1.47 | 0.261 | 0.386 | 0.976 |
| copy_anchor | **0.390** | **0.529** | 1.87 | 0.351 | 0.229 | 1.000 |
...
> **BİRİNCİL (NED)** `comparative` vs `majority_character`: fark **-0.0684** (düşük olan iyi), %95 GA [-0.1087, -0.0307] → **motor daha iyi**.
