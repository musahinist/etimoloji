...
class DeepDonorEtymologyDatabase:
    def lookup(self, word: str) -> Optional[Dict[str, Any]]:
        ...
        # Canlı Çok Dilli Wiktionary REST API ve Donör Sorgusu (Jenerik)
        try:
            ...
            if wik_res.get("raw_found") and wik_res.get("api_summary"):
                ...
                if any(lang in summary_text for lang in ["French", "Fransızca", "Arabic", "Arapça", "Persian", "Farsça", "Greek", "Grekçe", "Armenian", "Italian", "Latin"]):
                    return {
                        "word": w,
                        "found": True,
