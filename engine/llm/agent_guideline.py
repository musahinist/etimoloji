...
3. **BİLİMSEL VE NET ANLATIM**:
   - Varsa kaynak dildeki köken biçimini (örn: Ermenice, Grekçe, Farsça, İtalyanca) ve kelime parçalarını açıkça belirt.
   - Kelimenin Türkçedeki ve diyalektlerdeki anlamını ve tarihsel evrimini açıkla.
"""
