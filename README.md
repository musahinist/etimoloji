...
| Alıntı F — WOLD/Sakha (n=769) | **0,657** (4.3.5; 4.3.2'de 0,658) | 0,464 hepsi-alıntı | ✅ fonotaktiğe karşı anlamlı (+0,066 doğruluk, GA [+0,027, +0,105], p=0,002) · ⚠️ yalnız verici yakınlığına karşı anlamlı **değil** (−0,009, p=0,47) · eşik-sabit `engine *` 0,636 → 0,661, iç içe 0,638 → 0,645 (Kiril ``ҕ``/``ҥ`` düzeltmesi, 4.3.5) |
...
| Verici dil tanıma — WOLD Saha (n=440) | **0,730** (4.3.5; 4.3.2'de 0,714) | 0,575 çoğunluk (Rusça) | ✅ anlamlı (McNemar p<0,001) · Moğolca en zayıf (87/166; önce 81) · Kiril ``ҕ``/``ҥ`` artık silinmiyor: Yakutça tanıklar indekste bulunuyor |
| Verici dil tanıma — **Türkçe** (TDK+Nişanyan, train+dev n=293) | **0,771** (gösterilen etiket, 9n+9o, GA [0,720–0,816]) · doğal dağılım ağırlıklı **0,717** · en yakın biçimin dili 0,642 (doğal 0,602) | 0,505 çoğunluk | ✅ çoğunluğun üstünde (GA dışında) · **biçim kesinliği** (gösterilen verici biçimi doğru etimon) 0,473 (138/292) → **0,736** (142/193), **kapsama** (biçimli etiket) 0,997 → 0,580 (9n) → **0,659** (9o biçim-öncelikli arama): şans düzeyindeki eşleşmede biçim gösterilmez, dil doğal dağılım önseli + biçim ipuçlarıyla verilir; anlam havuzu doğru etimonu getiremediyse o dilde biçimce çok yakın ve anlamca örtüşen madde ünsüz iskeleti dizininden aranır · kör indeksle **0,703** [0,648–0,753] (doğal ağırlıklı 0,656; 9n öncesi 0,597 / 0,564; 9n'deki 0,782 / 0,707'den küçük düşüş biçim ipucu modelinin 9o altınını dışlayacak biçimde yeniden eğitilmesinden) · 4.3.0'da 0,563 / kör 0,515: 9e (Fransızca G2), 9f (sonek H1), 9l (anlam köprüsü S1) kuralları · Fransızca duyarlılık 0,36 → 0,68, Arapça 0,80 → 0,76 (9m: 7 Arapça kaybın 7'si G2'nin ayrı Fransızca havuzunda, tabanın Arapça etiketi yanlış etimonlu şans eşleşmesiydi; TDK `lisan` doğal dağılımıyla ağırlıklı 0,505 → 0,602) · dev (n=64) 0,672 · "Wiktionary↔TDK uyumu", bağımsız doğruluk değil (tam indeksle arama 0,918 / zincir 0,921 / dedektör 0,945: indeksin köken etiketini okur) |
...
| Verici etiketi — **bağımsız rapor altınları** (her biri ön kayıtlı, rapor bölümü **bir kez** açıldı; sayılar o koşudan) | 9l yeni TDK GTS (n=441): **0,329 → 0,417** | kural kapalı | ✅ 9d Farsça üzerinden Arapça, dev n=64: 0,484 → 0,641 (10/0, Holm p=0,004) · 9e yeni Wiktionary altını (n=560): 0,463 → 0,548 (57/9, Holm p=2e-9) · 9f fr/it altını (n=240): 0,396 → 0,438 (10/0, Holm p=0,004) · 9l S1 anlam köprüsü: 39/0, Holm p≈1e-11 · ⚠️ 9j TDK GTS (n=710) 0,211 ve TETTL (n=573) 0,255 — adaylar red; 9l sonrası aynı bölümler (artık görülmüş, yalnız bilgi) 0,303 / 0,300 · İtalyanca en zayıf sınıf (9j: 22/200) · 9g eski dil havuzu (Rumca/Ermenice) raporda 0,285 → 0,439 ama Türkçe korumada düştü → kapalı · 9m doğal oranlı yeni TDK altını (n=600, ar 290 / fr 248 / fa 62): Fransızca kuralları (G2+H1) doğal ağırlıklı 0,418 → **0,465** (45/17, p=0,0005; Arapça 0,583 → 0,528, Fransızca 0,274 → 0,452) · Arapça bedelini geri alma adayları (R1 H1'den -ik, R2 Arapça iskelet koruması, R3) red (en iyisi R2 0,466, 3/2, Holm p=1,0) · **9n** doğal oranlı yeni TDK altını (n=600, 9m dahil önceki altınların dışında): şans düzeyinde biçimi gizleyip dili doğal önsel + biçim ipuçlarıyla vermek (A2) biçim kesinliği 0,451 → **0,757** (Fisher p=5e-44; gösterilen yanlış biçim 237 → 55), doğal ağırlıklı dil doğruluğu 0,458 → **0,598** (94/10, Holm p=1e-5), kapsama 0,720 → 0,377 · aile düzeyi etiket (A1) 0,401 red · **9o** doğal oranlı yeni TDK altını (n=600, 9n dahil önceki altınların dışında): biçim-öncelikli ikinci arama (C2: ünsüz iskeleti dizini + geniş anlam sözcükleri + Türkçe anlamın sözcük köprüsü, dil a2'ninki) kapsama 0,375 → **0,458** (50/0, Holm p=4e-15), biçim kesinliği 0,693 → 0,720 (eklenen 50 biçimin 42'si doğru etimon), doğal ağırlıklı dil 0,590 → 0,608 · C1 (0,718) ve C3 (0,713) kesinlik eşiği 0,72'de red |
...
| Rekonstrüksiyon NED (5 katlı ÇD, train+dev n=320) — **sütun modeli** (üretim) | **0,329** (4.3.5; 4.3.2'de 0,327) | 0,344 öğrenilmiş tablo · 0,371 `majority_character` | ✅ tabloya karşı anlamlı (−0,015, GA [−0,027, −0,004]) · tam 0,297 vs 0,272 ✅ · BCFS 0,554 · öğrenilmiş tablo `majority_character`'a karşı BCFS +0,021, GA [−0,001, +0,040] → **H2 artık desteklenmiyor** (4.3.2'de +0,024, GA alt sınırı +0,002): fark TEK maddeden — Kuman *suzug* + Yakutça *ohoɣos* (altın \*sučuk); ``оһоҕос`` eskiden indekste ``ohoos`` olduğu için tanık "tanıksız" sayılıp çapa geri-dönüşü (\*suzug, NED 0,4) veriliyordu, şimdi tanıklı bulunuyor ve karşılaştırmalı yol \*hoğos / \*soo üretiyor (NED 1,0 / 0,8). Eski değer silinen harfle şişmişti · `make eval-cv` |
...
`data/cache/work/xtr/xborrowing_tune.json`); "Verici dil tanıma — Türkçe"
satırı ENGINE_VERSION 4.3.2 (9n, dürüst verici etiketi) koşusundandır
(`data/eval/tr_donor.json`). "Alıntı F — WOLD/Sakha", "Verici dil tanıma — WOLD Saha"
ve "Rekonstrüksiyon NED (5 katlı ÇD)" satırları ENGINE_VERSION 4.3.5 (Türk Kiril
harfleri ``ҥ ҕ ј ҹ ӌ ҝ`` artık silinmiyor, ``ӓ ӳ ў ӂ`` doğru eşleniyor; indeks
yeniden kuruldu, 1.823 kaydın karşılaştırma biçimi değişti) koşusundandır; aynı
koşuda akraba B-Cubed, başlık kökü, `xturkic` ve denetim değişmedi, eşsesli
(a) 0,773 aynı. İstisna: "bağımsız rapor
altınları" satırı — o bölümler ön kayıtla **bir kez** açıldı; sayılar o
koşulardan (22622b3, afabb8b, 79290de, dd630e3, 623ecea; 9m 8af1093; 9n ön kaydı 607da37) aktarılmıştır, bu
